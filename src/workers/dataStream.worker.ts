...
import type { MetricPoint, StreamPayload } from '../types'
...
const tick = () => {
  ...
  // generate 0–2 random events this tick
  ...
  // postMessage sends data from Worker to the main thread
